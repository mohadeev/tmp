...
const advisors = [
	{
		...
		isOnline: true,
		description:
			'Experienced business consultant with 10+ years helping companies grow and optimize their operations.',
	},
	{
		id: '2',
		name: 'Michael Chen',
		...
		isOnline: true,
		description:
			'Certified financial planner specializing in investment strategies and retirement planning.',
	},
	{
		id: '3',
		name: 'Lisa Rodriguez lksdv',
		title: 'Career Coach',
		rating: 4.9,
		reviews: 156,
		rate: 2.75,
		...
		isOnline: false,
		description:
			'Professional career coach helping individuals advance their careers and find their dream jobs.',
	},
]
				...
				<div className="space-y-6">
					<div>
						...
						<p className="text-muted-foreground">
							Connect with verified professionals for expert guidance
						</p>
					</div>
